  ...
  return {
    'en': {
        ...
        staticText: {
            ...
            linkQA: 'Afterword & Updates (Japanese)',
            linkFeedback: 'Feedback',
            linkAbout: 'What are Play Points?',
            linkWidget: 'Free widget (Japanese)',
    ...
    <!-- DESCRIPTION_SECTION_END -->`,
        ...
        <p class="meta-line">Operator: <a href="/en/author/katakata.html" rel="author">katakata</a> / Content updated: ${TOP_PAGE_CONTENT_DATES.en}</p>
        <!-- META_LINE_END -->`,
    ...
    'ko': {
        ...
        staticText: {
            ...
            linkTerms: '이용약관 (일본어)',
            linkQA: '후기 및 업데이트 (일본어)',
            linkFeedback: '의견 제안',
            linkAbout: 'Play 포인트란?',
            linkWidget: '무료 위젯 (일본어)',
    ...
    <!-- DESCRIPTION_SECTION_END -->`,
        metaLine: `        <!-- META_LINE_START -->
        <p class="meta-line">운영자: <a href="/ko/author/katakata.html" rel="author">katakata</a> / 콘텐츠 업데이트: ${TOP_PAGE_CONTENT_DATES.ko}</p>
        <!-- META_LINE_END -->`,
        trademarkDisclaimer: `        <!-- TRADEMARK_DISCLAIMER_START -->
    ...
    <!-- DESCRIPTION_SECTION_END -->`,
        metaLine: `        <!-- META_LINE_START -->
        <p class="meta-line">營運者: <a href="/tw/author/katakata.html" rel="author">katakata</a> / 內容更新: ${TOP_PAGE_CONTENT_DATES.tw}</p>
        <!-- META_LINE_END -->`,
        trademarkDisclaimer: `        <!-- TRADEMARK_DISCLAIMER_START -->
