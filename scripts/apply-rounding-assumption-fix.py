...
translation_updates = {
    'resultLabelRate: "適用獲得率", resultLabelEarnedPoints:': '''resultLabelRate: "適用獲得率",
            ...
            resultLabelEarnedPoints:''',
    'resultLabelRate: "Applied earn rate", resultLabelEarnedPoints:': '''resultLabelRate: "Applied earn rate",
            ...
            resultLabelEarnedPoints:''',
    'resultLabelRate: "적용 적립률", resultLabelEarnedPoints:': '''resultLabelRate: "적용 적립률",
            ...
            resultLabelEarnedPoints:''',
    'resultLabelRate: "套用回饋率", resultLabelEarnedPoints:': '''resultLabelRate: "套用回饋率",
...
for old, new in translation_updates.items():
    config = replace_once(config, old, new, f'add translations after {old}')
