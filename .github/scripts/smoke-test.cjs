...
const targets = [
  ...
  { url: 'https://playpoint-sim.com/en/amount/10000/', contains: '$50' },
  ...
  { url: 'https://playpoint-sim.com/ko/amount/10000/', contains: '50,000원' },
  ...
  { url: 'https://playpoint-sim.com/tw/amount/10000/', contains: 'NT$1,500' },
