...
export const CONFIGS = {
    ...
    'US': {
        ...
        uiText: {
            ...
            linkArticles: { text: "📝 Articles (JP)", href: "blog/" },
            linkKatakata: { text: "🧪 KatakataLab (JP)", href: "https://katakatalab.com/" },
            linkPrivacy: { text: "Privacy Policy (JP)", href: "privacy.html" },
            linkTerms: { text: "Terms of Service (JP)", href: "terms.html" },
            linkQA: { text: "Q&A & Afterword (JP)", href: "info.html" },
            ...
            linkDiscount: { text: "💡 Official Play Store", href: "https://play.google.com/store/points" },
            linkAuthor: { text: "Operator & Policy (JP)", href: "author/katakata.html" },
    ...
    'KR': {
        ...
        uiText: {
            ...
            linkArticles: { text: "📝 가이드 목록 (JP)", href: "blog/" },
            linkKatakata: { text: "🧪 KatakataLab (JP)", href: "https://katakatalab.com/" },
            linkPrivacy: { text: "개인정보처리방침 (JP)", href: "privacy.html" },
            linkTerms: { text: "이용약관 (JP)", href: "terms.html" },
            linkQA: { text: "Q&A 및 후기 (JP)", href: "info.html" },
            ...
            linkDiscount: { text: "💡 공식 플레이 스토어", href: "https://play.google.com/store/points" },
            linkAuthor: { text: "운영자 및 정책 (JP)", href: "author/katakata.html" },
    ...
    'TW': {
        ...
        uiText: {
            ...
            linkArticles: { text: "📝 指南列表 (JP)", href: "blog/" },
            linkKatakata: { text: "🧪 KatakataLab (JP)", href: "https://katakatalab.com/" },
            linkPrivacy: { text: "隱私權政策 (JP)", href: "privacy.html" },
            linkTerms: { text: "服務條款 (JP)", href: "terms.html" },
            linkQA: { text: "Q&A 與後記 (JP)", href: "info.html" },
            ...
            linkDiscount: { text: "💡 官方 Play 商店", href: "https://play.google.com/store/points" },
            linkAuthor: { text: "營運者與政策 (JP)", href: "author/katakata.html" },
