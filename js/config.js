...
export const CONFIGS = {
    'JP': {
        ...
        uiText: {
            ...
            resultLabelEarnedPoints: "獲得ポイント予測", resultRateSourceDirect: "直接入力の獲得率を使用", resultRateSourceMultiplier: "ステータス×倍率を使用", resultRateSourceSame: "どちらも同じ獲得率",
    ...
    'US': {
        ...
        uiText: {
            ...
            resultLabelEarnedPoints: "Estimated points earned", resultRateSourceDirect: "using direct rate entry", resultRateSourceMultiplier: "using level rate × multiplier", resultRateSourceSame: "both inputs give the same rate",
    ...
    'KR': {
        ...
        uiText: {
            ...
            resultLabelEarnedPoints: "예상 적립 포인트", resultRateSourceDirect: "직접 입력 적립률 사용", resultRateSourceMultiplier: "등급 적립률×배율 사용", resultRateSourceSame: "두 입력의 적립률이 같음",
    ...
    'TW': {
        ...
        uiText: {
            ...
            resultLabelEarnedPoints: "預估獲得點數", resultRateSourceDirect: "使用直接輸入回饋率", resultRateSourceMultiplier: "使用等級回饋率×倍率", resultRateSourceSame: "兩種輸入的回饋率相同",
