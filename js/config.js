...
export const CONFIGS = {
    'JP': {
        ...
        uiText: {
            ...
            tabMain: "必要な金額を調べる", tabReverse: "もらえるポイントを調べる", tabDiary: "ウィークリーリワード記録", lastCalculationReuse: "前回の条件を使う",
            ...
            sectionTitleReverse: "課金額からポイントを計算", labelAmountYen: "課金額（円）",
            ...
            errorTargetConsistency: "必要ポイントが、選択した目標の上限を超えています。",
            errorTargetConsistencyDetail: "{target}を目指す場合は0〜{max}ptで入力してください。別のランクを目指す場合は「目標ステータス」を変更してください。",
            resultLabelNeededPoints: "目標までの必要ポイント", resultLabelTotalYen: "合計の必要課金額目安", resultCheerUnder500: "もう一歩！", resultCheerLast100: "ラストスパート🔥",
            ...
            resultComparisonTitle: "通常時との比較", resultComparisonBase: "通常還元の場合", resultComparisonSelected: "現在の還元条件", resultComparisonSaved: "少なくなる目安", resultComparisonSame: "この条件では必要額の概算が同じため、差額はありません。",
            resultLabelRate: "適用獲得率",
            roundingNoteWithoutPack: "この試算は購入ごとのポイント四捨五入を含めない概算です。実際の獲得は購入の分け方で前後します。",
            roundingNoteReverse: "入力した金額を1回の購入として四捨五入しています。複数回の購入合計を入力した場合、実際のポイントと異なることがあります。",
            resultLabelEarnedPoints: "獲得ポイント予測", resultRateSourceDirect: "通常獲得率を使用", resultRateSourceMultiplier: "キャンペーンの特別獲得率を使用", resultRateSourceSame: "どちらも同じ獲得率",
            purchaseCheckLabel: "買う前にギフトコードの還元条件を見る", purchaseCheckNote: "還元上限・エントリー・使い切り期限を確認",
            perMonth: "/月", perWeek: "/週", perDay: "/日", daysUnit: "日",
            approxLabel: "約",
            descriptionSectionTitle: "Play Points 計算機でできること",
            articleDrawerTitle: "よくある悩み・おすすめ記事",
            ...
            weekLabel: "第", weekSuffix: "週", pointsPlaceholder: "ポイント", prizeLabel: "受け取った景品", saveButton: "結果を記録",
            ...
            linkQA: { text: "あとがき・アップデート情報", href: "info.html" },
    ...
    'US': {
        ...
        uiText: {
            ...
            resultLabelNeededPoints: "Points to goal", resultLabelTotalYen: "Estimated total spending", resultCheerUnder500: "Almost there!", resultCheerLast100: "Final push 🔥",
            ...
            resultComparisonTitle: "Compared with the base rate", resultComparisonBase: "At the base rate", resultComparisonSelected: "With the selected rate", resultComparisonSaved: "Estimated difference", resultComparisonSame: "The estimated spend is the same under these conditions, so there is no difference.",
            resultLabelRate: "Applied earn rate",
            roundingNoteWithoutPack: "This estimate does not apply purchase-by-purchase point rounding. Actual points can vary with how purchases are split.",
            ...
            resultLabelEarnedPoints: "Estimated points earned", resultRateSourceDirect: "using the base earn rate", resultRateSourceMultiplier: "Promotion special earn rate used", resultRateSourceSame: "both inputs give the same rate",
            purchaseCheckLabel: "Check gift card conditions before buying", purchaseCheckNote: "Confirm caps, activation, and expiration first",
            ...
            weekLabel: "Week", weekSuffix: "", pointsPlaceholder: "Points", prizeLabel: "Prize received", saveButton: "Record result",
            ...
            linkAuthor: { text: "Operator & Policy", href: "/en/author/katakata.html" },
    ...
    'KR': {
        ...
        uiText: {
            ...
            resultLabelNeededPoints: "목표까지 필요한 포인트", resultLabelTotalYen: "총 예상 결제 금액", resultCheerUnder500: "한 걸음만 더!", resultCheerLast100: "마지막 스퍼트🔥",
            ...
            resultComparisonTitle: "기본 적립률과 비교", resultComparisonBase: "기본 적립률", resultComparisonSelected: "선택한 적립 조건", resultComparisonSaved: "예상 차액", resultComparisonSame: "이 조건에서는 예상 필요액이 같아 차액이 없습니다.",
            resultLabelRate: "적용 적립률",
            roundingNoteWithoutPack: "이 결과는 구매 건별 포인트 반올림을 적용하지 않은 예상치입니다. 실제 적립은 구매 나누는 방식에 따라 달라질 수 있습니다.",
            roundingNoteReverse: "입력한 금액을 한 번의 구매로 보고 포인트를 반올림합니다. 여러 구매의 합계 금액이면 실제 포인트와 다를 수 있습니다.",
            resultLabelEarnedPoints: "예상 적립 포인트", resultRateSourceDirect: "기본 적립률 사용", resultRateSourceMultiplier: "프로모션 특별 적립률 사용", resultRateSourceSame: "두 입력의 적립률이 같음",
            purchaseCheckLabel: "구매 전 기프트카드 조건을 확인", purchaseCheckNote: "상한, 활성화, 사용 기한을 먼저 확인",
            ...
            weekLabel: "제", weekSuffix: "주", pointsPlaceholder: "포인트", prizeLabel: "받은 리워드", saveButton: "결과 기록",
            ...
            linkQA: { text: "후기 및 업데이트 (일본어)", href: "info.html" },
            ...
            linkWidget: { text: "무료 위젯 (일본어)", href: "embed.html" },
            linkDiscount: { text: "💡 할인 구매 가이드", href: "articles/2026-06-20-discount-gift-cards.html" },
            linkAuthor: { text: "운영자 및 정책", href: "/ko/author/katakata.html" },
    ...
    'TW': {
        ...
        uiText: {
            ...
            resultLabelNeededPoints: "距離目標所需點數", resultLabelTotalYen: "預估總消費金額", resultCheerUnder500: "再一步！", resultCheerLast100: "最後衝刺🔥",
            ...
            resultComparisonTitle: "與一般回饋率比較", resultComparisonBase: "一般回饋率", resultComparisonSelected: "目前回饋條件", resultComparisonSaved: "預估差額", resultComparisonSame: "此條件下預估所需金額相同，因此沒有差額。",
            resultLabelRate: "套用回饋率",
            roundingNoteWithoutPack: "本結果不套用逐筆點數四捨五入。實際獲得點數可能因購買拆分而不同。",
            roundingNoteReverse: "系統會將輸入金額視為單筆購買並四捨五入點數。若輸入的是多筆購買總額，實際點數可能不同。",
            resultLabelEarnedPoints: "預估獲得點數", resultRateSourceDirect: "使用基本獲點率", resultRateSourceMultiplier: "採用活動特別獲點率", resultRateSourceSame: "兩種輸入的回饋率相同",
            purchaseCheckLabel: "購買前先確認禮物卡條件", purchaseCheckNote: "先確認上限、啟用與使用期限",
            ...
            weekLabel: "第", weekSuffix: "週", pointsPlaceholder: "點數", prizeLabel: "獲得的獎品", saveButton: "記錄結果",
            ...
            linkAuthor: { text: "營運者與政策", href: "/tw/author/katakata.html" },
