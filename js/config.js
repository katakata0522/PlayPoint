...
export const CONFIGS = {
    'JP': {
        ...
        rateUnit: "100円",
        spendUnit: 100,
        weeklyRewardEstimates: { 1.0: 0, 1.25: 3, 1.5: 5, 1.75: 10, 2.0: 30 },
        tooltips: {
        ...
        uiText: {
            ...
            siteDescription: "Google Play ポイントのランクアップまでに、あといくら必要かを目安計算できます。<br>現在ステータス、目標ステータス、必要ポイントを入力すると、必要な課金額やキャンペーン倍率込みの目安を確認できます。",
            legacySearchName: "Playポイント計算機として探している方も、このページで同じ計算ができます。",
            ...
            nextTargetNone: "次の目標はありません", statusKeep: "維持", statusUp: "昇格", subtractRewardsLabel: "年末までのウィークリーリワード獲得予想（自動加算）を差し引く", packAmountLabel: "1回あたりの平均課金パック額 (オプション)", packAmountPlaceholder: "例：9800", packUnit: "パック", resultLabelFinalNeededPoints: "実質必要ポイント", resultLabelRequiredPacks: "必要購入パック数", resultLabelFreeClear: "課金不要（リワードのみで達成可能）", errorInput: "有効な数値を入力し、目標ステータスを選択してください",
            ...
            approxLabel: "約",
            diaryHintCard: "<strong>毎週金曜日はウィークリーリワードの日！</strong> Google Play ストアでリワードを獲得して、今週の日記に記録しましょう。",
            ...
            fridayReminderText: "ウィークリーリワードを受け取ったら、日記に記録しましょう。",
    ...
    'US': {
        ...
        rateUnit: "$1",
        spendUnit: 1,
        weeklyRewardEstimates: { 1.0: 0, 1.1: 3, 1.2: 5, 1.4: 10, 1.6: 30 },
        tooltips: {
        ...
        uiText: {
            ...
            nextTargetNone: "No further levels", statusKeep: "Keep", statusUp: "Level Up", subtractRewardsLabel: "Subtract estimated weekly rewards until end of year", packAmountLabel: "Average pack spending per transaction (Optional)", packAmountPlaceholder: "e.g., 98", packUnit: "packs", resultLabelFinalNeededPoints: "Net points needed", resultLabelRequiredPacks: "Packs needed", resultLabelFreeClear: "No spending needed (Achievable via rewards alone)", errorInput: "Please enter valid numbers and select a target status.",
            ...
            linkArticles: { text: "📝 Articles (Japanese)", href: "blog/" },
    ...
    'KR': {
        ...
        rateUnit: "1,000₩",
        spendUnit: 1000,
        weeklyRewardEstimates: { 1.0: 0, 1.1: 3, 1.3: 5, 1.6: 10, 2.0: 30 },
        tooltips: {
        ...
        uiText: {
            ...
            nextTargetNone: "다음 목표 등급이 없습니다", statusKeep: "유지", statusUp: "승급", subtractRewardsLabel: "연말까지의 주간 리워드 예상 획득 포인트 차감", packAmountLabel: "1회당 평균 결제 팩 금액 (선택 사항)", packAmountPlaceholder: "예: 10000", packUnit: "팩", resultLabelFinalNeededPoints: "실질 필요 포인트", resultLabelRequiredPacks: "필요 구매 팩 수", resultLabelFreeClear: "결제 불필요 (리워드만으로 달성 가능)", errorInput: "올바른 숫자를 입력하고 목표 등급을 선택해 주세요",
            ...
            approxLabel: "약",
            diaryHintCard: "<strong>매주 금요일은 주간 리워드의 날!</strong> Google Play 스토어에서 리워드를 받고 이번 주 일지에 기록하세요.",
            ...
            linkArticles: { text: "📝 가이드 목록 (일본어)", href: "blog/" },
    ...
    'TW': {
        ...
        uiText: {
            ...
            nextTargetNone: "無下一目標等級", statusKeep: "維持", statusUp: "升級", subtractRewardsLabel: "扣除至年底前的每週獎勵預估點數", packAmountLabel: "單筆平均購買禮包金額 (選填)", packAmountPlaceholder: "例：300", packUnit: "包", resultLabelFinalNeededPoints: "實質所需點數", resultLabelRequiredPacks: "所需購買禮包數", resultLabelFreeClear: "無需消費 (僅靠每週獎勵即可達成)", errorInput: "請輸入有效數值並選擇目標等級",
            ...
            approxLabel: "約",
            diaryHintCard: "<strong>每週五是每週獎勵日！</strong> 快去 Google Play 商店領取獎勵並記錄在日記中吧。",
            ...
            linkArticles: { text: "📝 指南列表 (日文)", href: "blog/" },
