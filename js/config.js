...
export const CONFIGS = {
    'JP': {
        ...
        uiText: {
            ...
            siteDescription: "まずは現在のステータス、目標ステータス、あと必要なポイントを入力してください。<br>ランク達成までの課金額や、課金額から得られるポイントを目安として計算できます。",
    ...
    'US': {
        ...
        uiText: {
            ...
            siteDescription: "Start by entering your current status, target status, and points needed.<br>This calculator estimates the spending needed for level-up and the points earned from a purchase amount.",
            ...
            descriptionSectionTitle: "What You Can Do with Play Points Calculator",
