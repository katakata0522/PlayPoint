...
export const CALC = {
    ...
    calculate() {
        ...
        if (neededPoints === null || finalRate === null || !targetStatusLabel) return UI.displayResult(STATE.dom.result, texts.errorInput, true);
        ...
        if (finalRate <= 0) return UI.displayResult(STATE.dom.result, texts.errorRate, true);
