...
const CACHE_NAME = 'playpoint-calc-v20260629_0121';
const ASSETS = [
  './',
  './style.css?v=20260629_0121a',
  './favicon.svg',
  './ogp.png',
  './manifest.json',
  './icon-192.png',
  ...
  './js/calculator.js',
  './js/share.js',
  './js/main.js?v=20260629_0121a',
  './js/intent-tracking.js?v=20260629_0121a',
  './js/consent.js?v=20260619a',
  './js/third-party.js?v=20260629_0121a',
