...
const CACHE_NAME = 'playpoint-calc-v20260627_1655';
const ASSETS = [
  './',
  './style.css?v=20260627_1655a',
  './favicon.svg',
  './ogp.png',
  './manifest.json',
  './icon-192.png',
  ...
  './js/calculator.js',
  './js/share.js',
  './js/main.js?v=20260627_1655a',
  './js/intent-tracking.js?v=20260627_1655a',
  './js/consent.js?v=20260619a',
  './js/third-party.js?v=20260627_1655a',
