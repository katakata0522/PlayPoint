...
const CACHE_NAME = 'playpoint-calc-v20260713_0747-038cf5b1';
const ASSETS = [
  './',
  ...
  './js/calculator.js',
  './js/share.js',
  './js/main.js?v=20260713_0747a',
  './js/intent-tracking.js?v=20260713_0747a',
  './js/consent.js?v=20260619a',
  './js/third-party.js?v=20260713_0747a',
