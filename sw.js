...
const CACHE_NAME = 'playpoint-calc-v20260707_1649';
const ASSETS = [
  './',
  './style.css?v=20260707_1649a',
  './favicon.svg',
  './ogp.png',
  './manifest.json',
  './icon-192.png',
  ...
  './js/calculator.js',
  './js/share.js',
  './js/main.js?v=20260707_1649a',
  './js/intent-tracking.js?v=20260707_1649a',
  './js/consent.js?v=20260619a',
  './js/third-party.js?v=20260707_1649a',
